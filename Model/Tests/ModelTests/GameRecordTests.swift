...
class GameRecordTests: XCTestCase {
    ...
    let hands = [
        Hand(allowsRainbows: true, size: .four),
        Hand(allowsRainbows: true, size: .five)
    ]
